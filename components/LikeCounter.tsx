  ...
  return (
    <div className="relative flex items-center max-w-[8rem]">
      ...
      <input
        type="text"
        value={count}
        className="bg-gray-50 border border-gray-300 h-11 text-center text-gray-900 dark:bg-gray-700 dark:border-gray-600 dark:text-white text-sm block w-full py-2.5"
        disabled
      />
      <button
